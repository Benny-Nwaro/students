        ...
        <div className="bg-white rounded-lg shadow-lg m-12">
            <div className="m-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                    {["Subject Category", "Subject", "Level"].map((label) => (
                        <div className="mb-4" key={label}>
                            <label className="block text-sm font-medium mb-1 text-[#9193A5]">{label}</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="mb-4">
                        ...
                        <input type="text" className="w-full border rounded-md p-2 placeholder-black" placeholder="Ex. begin your music career with piano lessons" />
                    </div>
                    <div className="mb-4">
                ...
                <div className="mb-4">
                    ...
                    <textarea className="w-full h-32 border rounded-md p-2 placeholder-black" placeholder="Write a compelling paragraph about the course"></textarea>
                </div>
                <div className="grid grid-cols-2 gap-4">
                    <div className="mb-4">
                        <label className="block text-sm font-medium mb-1 text-[#9193A5]">Discount (%)</label>
                        <input type="number" className="w-full border rounded-md p-2 placeholder-black" placeholder="Discount percentage" />
                    </div>
                    <div className="mb-4">
                        <label className="block text-sm font-medium mb-1 text-[#9193A5]">Discount end date</label>
                        <input type="date" className="w-full border rounded-md p-2 uppercase" />
                    </div>
                </div>
